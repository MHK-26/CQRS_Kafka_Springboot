package com.mhk26.account.query.api.controllers;

import com.mhk26.account.query.api.dto.AccountLookupResponse;
import com.mhk26.account.query.api.dto.EqualityType;
import com.mhk26.account.query.api.queries.FindAccountByHolderQuery;
import com.mhk26.account.query.api.queries.FindAccountByIdQuery;
import com.mhk26.account.query.api.queries.FindAccountWithBalanceQuery;
import com.mhk26.account.query.api.queries.FindAllAccountsQuery;
...
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAccountbyWithBalance(@PathVariable(value = "equalityType") EqualityType equalityType, @PathVariable(value = "balance") double balance){
        try {
